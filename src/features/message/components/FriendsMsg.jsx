  ...
  return (
    <div className="flex h-screen flex-col gap-2 mt-5 px-2 py-3">
      {friends.length > 0 ? (
        ...
        <div className="text-center text-xl text-(--text-primary) flex flex-col justify-center items-center gap-4">
          <p>No Friends yet for Messaging!</p>
          <img src="/no-following.svg" alt="" className="h-20 w-30" />
        </div>
      )}
    </div>
  );
