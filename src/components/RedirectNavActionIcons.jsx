...
export const Nav_Actions = () => {
  ...
  return (
    <div className="w-full   h-15  bg-(--bg-primary)   gap-4 px-2 flex justify-between items-center absolute lg:relative  bottom-0 lg:flex-col lg:h-full lg:border-l lg:py-30 lg:min-h-0 lg:border-(--border-color)  lg:justify-start">
      {IconsContent.map(({ text, icon: Icon, redirect }, indx) => (
        <div
          ...
          key={indx}
        >
          <Icon color={iconsColor} className="h-2 w-2 lg:h-10 h:w-10" />
