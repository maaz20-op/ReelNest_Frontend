...
export const Nav_Actions = () => {
  ...
  return (
    <div className="w-full  h-12    py-1  gap-4 px-2 flex justify-between items-center lg:flex-col lg:h-full lg:border-l lg:py-30 lg:min-h-0 lg:border-(--border-color)  lg:justify-start">
